...
class SocialIQAEncoder:
    ...
    def __init__(self, vocab_size: int = 10000, max_seq_len: int = 128,
...
class SocialIQAEvaluator:
    ...
    def evaluate(self, model: nn.Module, num_samples: int = 100,
                 device: str = 'cpu') -> SocialIQAMetrics:
        """
        ...
        results = {
            ...
            'emotion_correct': 0, 'emotion_total': 0,
            'motivation_correct': 0, 'motivation_total': 0,
            'subsequent_correct': 0, 'subsequent_total': 0,
            'prerequisite_correct': 0, 'prerequisite_total': 0,
        }
